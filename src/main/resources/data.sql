...
INSERT INTO shipping_requests (vehicle_type, payload_weight, velocity) VALUES
   ('TRUCK', 1500.50, 80),
   ('VAN', 450.00, 100),
   ('MOTORCYCLE', 25.0, 60),
   ('DRONE', 5.5, 40),
   ('CARGO_SHIP', 50000.0, 35)
ON CONFLICT DO NOTHING;


INSERT INTO vehicles (type, licensePlate, capacity, speed) VALUES
...
INSERT INTO orders (customer_name, weight, destination, shippingType, status, cost) VALUES
